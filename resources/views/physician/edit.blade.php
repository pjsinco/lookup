            ...
            <div class="col-xs-12">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('address_1', null, ['class' => 'form-control', 'id' => 'address1', 'placeholder' => 'Enter business address']) !!}
                    </div> <!-- .form-group -->

                    <div class="form-group">
                        <strong>{!! Form::label('Company Name', null, ['class' => 'control-label', 'for' => 'address_2']) !!}</strong>
                        {!! Form::text('address_2', null, ['class' => 'form-control', 'id' => 'address2', 'placeholder' => 'Enter Company Name']) !!}
                    </div> <!-- .form-group -->

                    <div class="form-group">
                        <strong>{!! Form::label('Business city', null, ['class' => 'control-label', 'for' => 'City']) !!}</strong>
                        {!! Form::text('City', null, ['class' => 'form-control', 'id' => 'city', 'placeholder' => 'Enter Business City']) !!}
                    </div> <!-- .form-group -->
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('Zip', null, ['class' => 'form-control', 'id' => 'zip', 'placeholder' => 'Enter Business Zip']) !!}
                    </div> <!-- .form-group -->

                    <div class="form-group">
                        <strong>{!! Form::label('Phone', null, ['class' => 'control-label', 'for' => 'Phone']) !!}</strong>
                        {!! Form::text('Phone', null, ['class' => 'form-control', 'id' => 'phone', 'placeholder' => 'Enter Business Phone']) !!}
                    </div> <!-- .form-group -->

                    <div class="form-group">
                        <strong>{!! Form::label('website', null, ['class' => 'control-label', 'for' => 'website']) !!}</strong>
                        {!! Form::url('website', null, ['class' => 'form-control', 'id' => 'website', 'placeholder' => 'Enter Business Website']) !!}
                    </div> <!-- .form-group -->
